...
.group-icon {
  ...
  border-radius: 50%;
  /* Aggiunge margine a destra per separare l'icona dal testo */
  margin-right: 10px;
}
...
.chat-input {
  ...
  /* Distribuisci uniformemente lo spazio tra gli elementi */
  justify-content: space-between;
  /* Aggiunge margine sopra all'area di input */
  margin-top: 20px;
  /* Imposta la posizione come assoluta per posizionare l'input in fondo alla finestra */
  position: absolute;
  /* Allinea l'input in basso */
  bottom: 0;
